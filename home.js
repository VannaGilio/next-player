...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        if (usuario) {
            ...
            document.getElementById('foto-perfil-logado').src = usuario.imagemPerfil || './img/image.png';
    ...
    carregarPostagens(); // Chama aqui para garantir que usuários estão carregados
})